...
GH_REPO <- "adg_dynasty_league_power_rankings"
GH_BRANCH <- "main"
...
# List cached per-season transaction CSVs: GitHub contents API (fresh),
# local fallback. Mirrors list_weekly_files().
list_transaction_files <- function(cfg) {
dir_path <- file.path(cfg$data_dir, "Transactions")
api <- suppressWarnings(tryCatch(
jsonlite::fromJSON(paste0("https://api.github.com/repos/", GH_USER, "/",
GH_REPO, "/contents/",
utils::URLencode(dir_path))),
...
".rank-table-wrap .gt_table img { height: 40px !important; width: auto !important; }",
".rank-table-wrap tbody tr { display: block; border: 1px solid #ddd; border-radius: 8px; margin-bottom: 10px; padding: 8px 10px; overflow: hidden; }",
".rank-table-wrap tbody td { border: none !important; padding: 3px 0 !important; font-size: 14px !important; text-align: left !important; line-height: 1.4 !important; height: auto !important; vertical-align: baseline !important; }",
".rank-table-wrap tbody td:nth-child(1) { display: block; float: left; font-size: 18px !important; font-weight: 700; margin-right: 6px; }",
".rank-table-wrap tbody td:nth-child(2) { display: block; float: left; margin-right: 6px; }",
".rank-table-wrap tbody td:nth-child(3) { display: block; float: left; clear: left; margin: 6px 8px 6px 0; }",
".rank-table-wrap tbody td:nth-child(4) { display: block; float: left; font-size: 17px !important; font-weight: 600; margin-top: 12px; }",
".rank-table-wrap tbody td:nth-child(5) { display: block; clear: both; }",
".rank-table-wrap tbody td:nth-child(6) { display: inline-block !important; width: auto !important; padding: 4px 10px !important; border-radius: 6px; font-weight: 700; margin: 4px 0 !important; }",
...
".rank-table-wrap tbody td:nth-child(6):before { content: \"Rating: \"; font-weight: 600; color: inherit; }",
